...
const int led1 = 30;  // LED verde    esta encendido en pin Digital 4
const int led2 = 31;  // LED rojo     esta encendido en pin Digital 3
const int led3 = 32;  // LED amarillo esta encendido en pin Digital 2
const int led4 = 33;  // LED de advertencia de voltaje esta encendido en el Pin digital D5
const int led5 = 34;  // LED de advertencia de temperatura esta encendido en el pin D6
const int led6 = 35;  // LED de advertencia de peligro colisión en el pin 27
const int LowBatVolts5 = 4.6;   // esto es para mantener el valor de advertencia de voltaje de bateria bajo en el umbral de 4.6 V
...
{
  int BattVolt_5;             // Recibe mensaje de voltaje de batería
  ...
  if ( millis() - auxMillis > intervaloEncendido) {
    ...
    for (int i = 0; i < 5; i++) { // Esta función, cambia el estado de envio a recepción cada 5 segundos
      ...
      if (ETin.receiveData())    // Recibe el mensaje al puerto serie para el Arduino del ROV
      {
        ...
        if (rxdata.BattVolt_5 < LowBatVolts5)
        {
      ...
      Serial.print (float(rxdata.BattVolt_5), 3);
