...
const int led1 = 40;  // LED verde    esta encendido en pin Digital 4
const int led2 = 42;  // LED rojo     esta encendido en pin Digital 3
const int led3 = 44;  // LED amarillo esta encendido en pin Digital 2
const int led4 = 46;  // LED de advertencia de voltaje esta encendido en el Pin digital D5
const int led5 = 48;  // LED de advertencia de temperatura esta encendido en el pin D6
const int led6 = 50;  // LED de advertencia de peligro colisión en el pin 27
