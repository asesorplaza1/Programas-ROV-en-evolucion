...
ESC ESCVL(3, 1100, 1900, 500); // Crea un ESC para el motor arriba izquierda
ESC ESCVR(4, 1100, 1900, 500); // Crea un ESC para el motor arriba derecha
ESC ESCHL(5, 1100, 1900, 500); // Crea un ESC para el motor izquierdo
ESC ESCHR(6, 1100, 1900, 500); // Crea un ESC para el motor derecho
...
{
  int upLraw;   // Variables para transportar los datos sin procesar reales de los ESC
  int upRraw;
  int HLraw;
  int HRraw;
...
void loop ()
{
...

  {
    ...
    loop_ACS712_12V();      // Bloque de tranajo del Amperimetro de la bateria de 12V
    loop_CamServo();        // Bloque de trabajo del servo de la cámara
